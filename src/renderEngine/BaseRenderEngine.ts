import { T_CameraConfig, cameraConfigSchema, T_SceneConfig, sceneConfigSchema, T_RenderEngineConfig, rendererConfigSchema, T_RendererConfig, T_EngineOutput } from "../types/renderEngine/renderEngine";
...
export abstract class BaseRenderEngine {
    ...
    abstract generateStandalonePrimitive(): void;
